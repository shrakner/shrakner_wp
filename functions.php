...
function toolbox_posted_on() {
    printf( __( '<a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'toolbox' ),
        esc_url( get_permalink() ),
        esc_attr( get_the_time() ),
        esc_attr( get_the_date( 'c' ) ),
        '<span class="date-month">' . esc_html( get_the_date( 'M' )  ). '</span><span class="date-day">' . esc_html( get_the_date( 'd' ) ) . '</span><span class="date-year">' . esc_html( get_the_date( 'Y' ) ) . '</span',
